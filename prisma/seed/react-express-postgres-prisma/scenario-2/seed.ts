            ...
            learning_sections: {
              create: [
                ...
                },
                {
                  ...
                  content:
                    "When you need to update something you see in the browser, ask:\nWhat element is it? (navbar, footer, sidebar?)\nWhich component renders it? (trace it to a file)\nIs the text hardcoded or coming from props/state? For brand text in the navbar, you'd look inside the layout's navbar component for a hardcoded string like \"UrbanPottery\" or similar.",
                  order: 4,
                },
                {
