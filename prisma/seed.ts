...
async function main() {
  ...
  // Insert epics second (depends on scenario_id)
  console.log("\n🏃 Creating epics...\n");
      ...
      tasks: {
        create: [
          ...
          },
          {
            ...
            test_type: "client", // UI change only — client test
            user_story:
        ...
        create: [
          {
            ...
            test_type: "server", // borrow.controller.ts is server-side
            user_story:
          ...
          },
          {
            ...
            test_type: "server", // Prisma transactions are server-side
            user_story:
        ...
        create: [
          {
            ...
            test_type: "both", // client/src/services/libraryService.ts + server/src/controllers/reservation.controller.ts
            user_story:
          ...
          },
          {
            ...
            test_type: "both", // client reservation list + server return/cancel flow
            user_story:
        ...
        create: [
          {
            ...
            test_type: "server", // overdue report logic is in server borrow controller
            user_story:
          ...
          },
          {
            ...
            test_type: "server", // overdue fix and utility is server-side
            user_story:
  ...
  for (const level of levels) {
    await prisma.level.create({ data: {
      ...
      order: level.order,
      sprint_number: level.sprint_number,
      deadline: level.deadline,
      level_description: level.level_description ?? "no description provided for this level",
      xp_reward: level.xp_reward ?? 100,
      key_takeaways: level.key_takeaways ?? "no key takeaways provided for this level",
      epic_id: level.epic_id!,
      scenario_id: level.scenario_id!,
      coin_reward: level.coin_reward ?? 50,
    }});
