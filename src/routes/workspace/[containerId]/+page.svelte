...
<ConfirmationModal
  ...
  description={`You finished the crash course for Task ${crashCoursePromptTaskNumber}. You can always review the crash course from the button located at the upper right corner of the workspace. Move this ticket to in progress when you're ready.`}
  confirmLabel="Got it"
  cancelLabel="Back"
  variant="primary"
...
<ConfirmationModal
  ...
  description={`You closed the crash course before marking it as finished. You can return now or open it again later from the tab button at the upper right corner of the workspace.`}
  confirmLabel="Got it"
