...
{#if isOpen}
  ...
  >
    <div
      class="relative w-[min(52rem,95vw)] overflow-hidden rounded-card border bg-obsidian-bg-light shadow-accent-glow-lg"
    ...
    >
      ...
      <!-- Header -->
      <div class="flex items-center justify-between gap-4 border-b border-[var(--card-border)] px-8 py-5">
        ...
        {:else}
          <div class="flex flex-wrap justify-center gap-4">
            {#each rewards as reward, idx (reward.day)}
              <div
                class="flex w-[calc(50%-0.5rem)] flex-col items-center rounded-card border border-obsidian-accent/25 bg-obsidian-bg px-3 py-3.5 transition-all duration-200 sm:w-[11rem]"
              ...
              >
                ...
                <div class="mt-2.5 grid w-full grid-cols-3 gap-1.5">
                  <span class="inline-flex items-center justify-center gap-1 whitespace-nowrap rounded-full bg-cyber-warn/10 px-1 py-1">
                    <Coins class="h-3 w-3 text-cyber-warn" />
                    <span class="font-label text-xs font-semibold text-cyber-warn tabular-nums">{reward.coins}</span>
                  </span>
                  <span class="inline-flex items-center justify-center gap-1 whitespace-nowrap rounded-full bg-cyber-cyan/10 px-1 py-1">
                    <Zap class="h-3 w-3 text-cyber-cyan" />
                    <span class="font-label text-xs font-semibold text-cyber-cyan tabular-nums">{reward.xp}</span>
                  </span>
                  <span class="inline-flex items-center justify-center gap-1 whitespace-nowrap rounded-full bg-cyber-purple/10 px-1 py-1">
                    <Bot class="h-3 w-3 text-cyber-purple" />
                    <span class="font-label text-xs font-semibold text-cyber-purple tabular-nums">{reward.aiHelps}</span>
                  </span>
                </div>
      ...
      <!-- Footer -->
      <div class="flex justify-end border-t border-[var(--card-border)] bg-obsidian-bg/40 px-8 py-4">
