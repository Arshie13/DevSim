...
<header
  class="workspace-header relative bg-[#0a0e1a] border-b border-[rgba(7,165,201,0.15)] px-3 py-2 flex items-center justify-between z-10"
...
<style>
  ...
  @media (max-width: 860px) {
    ...
    .header-actions button span:not(.animate-spin) {
      display: none;
    }
