...
<div class="card-cyber shadow-[0_0_20px_rgba(255,180,0,0.08)] hover:shadow-[0_0_35px_rgba(255,180,0,0.16)] transition-shadow duration-500" style="border-color: rgba(255,180,0,0.15);">
  <!-- Header -->
