...
{#if isOpen}
  ...
  >
    <!-- Header -->
    <div class="flex items-center justify-between px-16 py-4 border-b border-obsidian-accent/20 bg-obsidian-bg-light h-[90px]">
    ...
    <!-- Content -->
    <div class="h-[calc(100%-69px)] overflow-y-auto px-16 py-6 space-y-6">
