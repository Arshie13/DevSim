...
{#if isOpen}
  ...
  <!-- Drawer -->
  <div
    class="fixed top-0 right-0 h-full w-full max-w-2xl flex flex-col bg-obsidian-bg border-l border-obsidian-accent/20 z-50 shadow-[-10px_0_50px_rgba(0,0,0,0.5),0_0_40px_rgba(7,165,201,0.08)]"
