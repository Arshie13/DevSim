...
export function getTutorialWorkspaceData(stackName: string): TutorialWorkspaceData {
 ...
 export const STEPS: TutorialStep[] = [
    ...
    },
    {
      ...
      hint: 'Run: pnpm dlx prisma generate',
      switchTab: 'terminal',
    ...
    },
    {
      ...
      hint: 'Run: pnpm dlx prisma migrate dev',
      switchTab: 'terminal',
      command: 'pnpm dlx prisma migrate dev',
      requireCommand: true,
      target: 'terminal-panel',
      preferSide: 'left',
    },
    {
      ...
      hint: 'Run: pnpm dlx prisma db seed',
      switchTab: 'terminal',
      command: 'pnpm dlx prisma db seed',
      requireCommand: true,
      target: 'terminal-panel',
      preferSide: 'left',
    },
    ...
    },
    {
      ...
      instruction: 'Confirm the website is running in the Preview panel. Click the refresh button at the upper right if the preview is not loading.',
