...
function buildNestjsTaskOne(): ITask {
  ...
  const hints: IHints[] = [
    ...
    },
    {
      ...
      taskId,
      content:
        "Run `pnpm run prisma:migrate` from the project root after generating the Prisma client to apply the schema to the database.",
    },
  ];
...
export const STEPS: TutorialStep[] = [
  ...
  },
  {
    ...
    hint: "Run: pnpm run prisma:migrate",
    switchTab: "terminal",
