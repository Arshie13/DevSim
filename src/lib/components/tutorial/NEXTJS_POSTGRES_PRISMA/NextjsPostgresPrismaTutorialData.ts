...
export const STEPS: TutorialStep[] = [
  ...
  },
  {
    ...
    title: "Search Files",
    instruction:
      'Search for "To-Do List Tutorial" to find the TodoApp component you need to edit for Task 2.',
    hint: 'Type "To-Do List Tutorial" in the search box and click the highlighted result snippet.',
  ...
  },
  {
    ...
    title: "Search Works",
    instruction:
      "Great. Search opened the component in the editor and shows exactly where the header text is.",
    hint: "Click Next",
    target: "editor-workspace",
    confirmLabel: "Next",
    requireTargetClick: false,
  ...
  },
  {
    ...
    instruction:
      "This is Part 1 of the submit flow. The pre-flight summary shows your completion stats, Sprint Tasks lists what you completed, Workspace Deltas lists the files you changed, and the bottom row shows the XP and Coins you will earn. Click the Next button at the bottom of the modal to continue to Part 2.",
  ...
  },
  {
    ...
    instruction:
      "This is Part 2 — Mastery Checkpoint. The modal advances here automatically. Type a short reflection on what you learned (at least 80 characters). Use the Copy button below to paste the example into the field, then click Next at the bottom of the modal.",
  ...
  },
  {
    ...
    instruction:
      "This is Part 3 — Select Layers. The modal advances here automatically. Click Frontend + Database checkboxes.\nNote: In real workspace, this will be checked strictly.",
    hint: "",
